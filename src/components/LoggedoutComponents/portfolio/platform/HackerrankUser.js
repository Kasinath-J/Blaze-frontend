import dogear from "../../../../images/portfolio/platform/dog_Ear.jpg"

export function HackerrankUser(props) {
    ...
    function icon(name)
    {
        switch(name)
        {
            ...
            case "Problem Solving" :
                return <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.41041 98.75">
    ...
    <g id="problem_solving" data-name="problem solving">
      ...
      />
            ...
            case "Java" :
                return <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 73.23582 98.75">
                            <title>Java</title>
                            <g id="java">
            <path
                class="cls-1"
...
<g>
   ...
   <path class="st1" d="M6.3,78.9c0,0,35.9,21.1,86.5,0"/>
    ...
    function gradient(stars)
    {
        
        if(stars>=1 && stars<=2)
        {
            return <linearGradient id="badge-bronze-gradient" x1="52.5" y1="2.5" x2="52.5" y2="102.5" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#ffc5ab"></stop><stop offset="1" stop-color="#ffa38a"></stop></linearGradient>
        }
        else if(stars>=3 && stars<=4)
        {
            return <linearGradient id="badge-silver-gradient" x1="52.5" y1="2.5" x2="52.5" y2="102.5" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#cee3eb"></stop><stop offset="1" stop-color="#aec8c7"></stop></linearGradient>
        }
        else if(stars>=5 && stars<=6)
        {
            return <linearGradient id="badge-gold-gradient" x1="52.5" y1="2.5" x2="52.5" y2="102.5" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#f9d641"></stop><stop offset="1" stop-color="#f8bc36"></stop></linearGradient>
        }
    }
    
    function url_id(stars)
    {
        
        if(stars>=1 && stars<=2)
        {
            return "url(#badge-bronze-gradient)"
        }
        else if(stars>=3 && stars<=4)
        {
            return "url(#badge-silver-gradient)"
        }
        else if(stars>=5 && stars<=6)
        {
            return "url(#badge-gold-gradient)"
        }
    }
    ...
    function stars(s)
    {
        ...
        for(var i=0;i<s;i++)
        {
            ret.push(
                <svg
                    class="badge-star" viewBox="0 0 6.54904 6.25825" width="7" x={String(i*9)}>
                    <path
                        class="star"
    ...
    var verify_logo = <svg viewBox="0 -20 60 90" width="31" height="47" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M17.364 28.006a1.5 1.5 0 0 1 1.63 1.358l1 11a1.5 1.5 0 1 1-2.988.272l-1-11a1.5 1.5 0 0 1 1.358-1.63z"
      fill="#FFFFFF"
    />
    <path
      d="M15.5 3C8.596 3 3 8.596 3 15.5S8.596 28 15.5 28 28 22.404 28 15.5 22.404 3 15.5 3zM0 15.5C0 6.94 6.94 0 15.5 0 24.06 0 31 6.94 31 15.5 31 24.06 24.06 31 15.5 31 6.94 31 0 24.06 0 15.5z"
      fill="#FFFFFF"
    />
    <path
      d="M22.883 25.773a1.5 1.5 0 0 1 1.684 1.29l2.42 18.24a1.5 1.5 0 0 1-2.259 1.483L15.5 41.25l-9.228 5.537a1.5 1.5 0 0 1-2.259-1.484l2.42-18.22a1.5 1.5 0 0 1 2.974.395l-2.01 15.136 7.331-4.4a1.5 1.5 0 0 1 1.544 0l7.332 4.4-2.01-15.156a1.5 1.5 0 0 1 1.289-1.684z"
      fill="#FFFFFF"
    />
  </svg>
    
  return (
    <div id="portfolioHackerrank">
        ...
        {props.data.badges&&props.data.badges!==0&&<div><p className='mt-2'>Badges earned : </p>
            ...
            {props.data.badges.map((badge,index)=>{
                return(
                    <div key={index} id="portfolioHackerrankBadges" style={{height:"75px",width:"75px",display:"inline-block",margin:"0.8rem"}}>
                        <svg viewBox="0 0 91.66667 100" class="hexagon">
                            <g>
                            <defs>
                                {gradient(badge.stars)}
                            </defs>
                            <path
                                fill={url_id(badge.stars)}
                            ...
                            <svg x="35%" y="22" height="27" width="27" transform={translate_stars(badge.stars)}>
                                {icon(badge.badge_name)}
                            </svg>
                            <text class="badge-title" x="50%" y="65.5" font-size="10" text-anchor="middle">
                            {badge.badge_name}
                            </text>
                            <g class="star-section" transform={translate_stars(badge.stars)}>
                ...
                <div style={{display:"flex",justifyContent:"space-around"}}>
                    {
                        props.data.certificates.map((cert,index)=>{
                            return(
                                <a key={index} href={cert.cert_url} target="_blank" rel="noreferrer" style={{display:"inline-block",width:"100px",height:"133.325px",backgroundColor:"#1ba94c",color:"white",paddingLeft:"8px",marginRight:"5px"}}>
                                    <div style={{display:"flex",justifyContent:"space-around",padding:"0"}}>
                                        {verify_logo}
                                        <img src={dogear} height="35px" alt="" />
                                    </div>
                                        
                                        
                                        <div style={{position:"relative",top:"5%",fontWeight:"450",fontSize:"14px",height:"28px"}}>
                                                    <p>{cert.cert_name} (<span>{cert.cert_level}</span>)
                                                    </p>
                                        </div>
                                        <p style={{position:"relative",top:"25%",fontWeight:"600",fontSize:"14px"}}>Verified</p>
